...
const BY_TYPE: Record<string, Partial<SubmissionRequirementsResult>> = {
  ...
  web2: {
    ...
    mediaRequirements: {
      images: true,
      videos: false,
      imageNotes: 'Featured image recommended for Web 2.0 / blog posts',
    },
    contentLengthHints: { minWords: 800, maxWords: 1500 },
    descriptions: ['excerpt', 'metaDescription'],
  },
  article_submission: {
    requiredFields: [
      'title',
    ...
    mediaRequirements: {
      images: true,
      videos: false,
      imageNotes: 'Featured / hero image recommended',
    },
