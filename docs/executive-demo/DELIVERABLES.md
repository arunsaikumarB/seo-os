...
**Intelligence (2 min)**  
"Watch what happens when we analyze a website." *[Run discovery]* "In seconds: sitemap parsed, 47 pages analyzed, competitors found, keywords clustered, opportunities scored."
...
"This is where it gets powerful." *[Type: Analyze Chefgaa]* "Watch the AI think — reading knowledge base, ranking opportunities, building context. Then a full competitive analysis streams in real time."

*[Type: Create campaign]* "Campaign created with plan, phases, and attached opportunities."

*[Type: Generate guest post]* "1,200-word draft, brand-validated by QA Agent."
