...
export const FIELD_ALIASES: Record<FillableRole, string[]> = {
  ...
  further_info: [
    'further company',
    'further company / product / service information',
    'further company product service information',
    'further information',
...
export const ROLE_LABELS: Record<FieldRole, string> = {
  ...
  further_info: 'Further company info',
  article: 'Article',
  keywords: 'Keywords',
  address: 'Address',
  city: 'City',
...
export const TEACHABLE_ROLES: Array<{ role: FillableRole | 'skip'; label: string }> = [
  ...
  { role: 'meta_description', label: 'META Description' },
  { role: 'further_info', label: 'Further company info' },
  { role: 'article', label: 'Article' },
  { role: 'keywords', label: 'Keywords' },
